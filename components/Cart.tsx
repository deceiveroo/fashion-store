      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-80 bg-gradient-to-b from-white to-gray-50/80 z-50 shadow-2xl border-l border-white/20 flex flex-col"
          >
                ...
                >
                  {items.map((item, index) => (
                    <motion.div
                      ...
                      className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-white/50 hover:shadow-xl transition-all"
                    >
                      ...
                      <div className="relative flex items-start gap-4">
                        ...
                        >
                          <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-0.5">
                            <Image
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 mt-3">
                            <motion.button
                              ...
                              className="w-7 h-7 flex items-center justify-center bg-gray-100 text-gray-600 rounded-lg hover:bg-purple-100 hover:text-purple-600 transition-colors"
                            >
                              <Minus size={14} />
                            </motion.button>
                            ...
                            <motion.span
                              ...
                              className="text-sm font-bold text-gray-900 min-w-6 text-center"
                            >
                              {item.quantity}
                            </motion.span>
                            ...
                            <motion.button
                              ...
                              whileTap={{ scale: 0.9 }}
                              onClick={() => handleUpdateQuantity(item.id, item.quantity + 1)}
                              className="w-7 h-7 flex items-center justify-center bg-gray-100 text-gray-600 rounded-lg hover:bg-pink-100 hover:text-pink-600 transition-colors"
                            >
                              <Plus size={14} />
                            </motion.button>
                          </div>
            ...
            {items.length > 0 && (
              <motion.div 
                ...
                className="border-t border-white/20 bg-white/90 backdrop-blur-sm p-6 space-y-4"
              >
                {/* Discount Badge */}
                {getDiscount() > 0 && (
                  <motion.div
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-gray-600">Товары ({itemCount} шт.)</span>
