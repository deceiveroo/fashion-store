...
export default function SignUp() {
  ...
  // ✅ Обновлённый handleSubmit с реальным API-запросом
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Улучшенная обработка ошибок — покажем конкретную причину, если API её вернул
        toast.error(data.message || data.error || 'Ошибка при регистрации');
      }
    } catch (error) {
